...
def main():
    ...
    categories_113_police_law = [
        ...
        "犯罪防治學系預防組", "行政管理學系", "行政警察學系", "法律學系", "資訊管理學系"
    ]
    ...
    # ================================================================
    fire_pattern = os.path.join(QUIZ_DIR, "消防學系", "113年", "消防與災害防救法規*", "試題.json")
    ...
    # ================================================================
    # 4. 刑事警察學系 110年 犯罪偵查學 Q7（缺D）、Q14（缺A）
    # ================================================================
    path_110_crime = os.path.join(QUIZ_DIR, "刑事警察學系", "110年", "犯罪偵查學", "試題.json")
    if os.path.exists(path_110_crime):
        ...
        if fix_question(data, 7, "D", "1345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/110年/犯罪偵查學 Q7: 補齊選項D='1345'")
        ...
        if fix_question(data, 14, "A", "1245"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/110年/犯罪偵查學 Q14: 補齊選項A='1245'")

        save_json(path_110_crime, data)

    # ================================================================
    # 5. 刑事警察學系 110年 犯罪偵查學 Q8（C=原始資料缺失）、Q9（D=原始資料缺失）
    # ================================================================
    if os.path.exists(path_110_crime):
        data = load_json(path_110_crime)
        ...
        if fix_question(data, 8, "C", "12345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/110年/犯罪偵查學 Q8: 修復選項C='12345'")
        ...
        if fix_question(data, 9, "D", "12345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/110年/犯罪偵查學 Q9: 修復選項D='12345'")

        save_json(path_110_crime, data)

    # ================================================================
    # 6. 刑事警察學系 111年 犯罪偵查學 Q10（缺A）、Q16（缺A）、Q22（缺B）
    # ================================================================
    path_111_crime = os.path.join(QUIZ_DIR, "刑事警察學系", "111年", "犯罪偵查學", "試題.json")
    if os.path.exists(path_111_crime):
        ...
        if fix_question(data, 10, "A", "1234"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/犯罪偵查學 Q10: 補齊選項A='1234'")
        ...
        if fix_question(data, 16, "A", "1345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/犯罪偵查學 Q16: 補齊選項A='1345'")
        ...
        if fix_question(data, 22, "B", "1345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/犯罪偵查學 Q22: 補齊選項B='1345'")

        save_json(path_111_crime, data)

    # ================================================================
    # 7. 刑事警察學系 111年 刑案現場處理與刑事鑑識
    # Q2（D=原始資料缺失）、Q11（缺D）、Q17（C=原始資料缺失）、Q25（A=原始資料缺失）
    # ================================================================
    path_111_scene = os.path.join(QUIZ_DIR, "刑事警察學系", "111年", "刑案現場處理與刑事鑑識", "試題.json")
    if os.path.exists(path_111_scene):
        ...
        if fix_question(data, 2, "D", "1234"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/刑案現場 Q2: 修復選項D='1234'")
        ...
        if fix_question(data, 11, "D", "1234"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/刑案現場 Q11: 補齊選項D='1234'")
        ...
        if fix_question(data, 17, "C", "12346"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/刑案現場 Q17: 修復選項C='12346'")
        ...
        if fix_question(data, 25, "A", "12345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/111年/刑案現場 Q25: 修復選項A='12345'")

        save_json(path_111_scene, data)

    # ================================================================
    # 8. 刑事警察學系 113年 刑案現場處理與刑事鑑識 Q2（缺D）
    # ================================================================
    path_113_scene = os.path.join(QUIZ_DIR, "刑事警察學系", "113年", "刑案現場處理與刑事鑑識", "試題.json")
    if os.path.exists(path_113_scene):
        ...
        if fix_question(data, 2, "D", "12345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/113年/刑案現場 Q2: 補齊選項D='12345'")

        save_json(path_113_scene, data)

    # ================================================================
    # 9. 刑事警察學系 114年 刑案現場處理與刑事鑑識 Q7（缺D）、Q11（缺A）
    # ================================================================
    path_114_scene = os.path.join(QUIZ_DIR, "刑事警察學系", "114年", "刑案現場處理與刑事鑑識", "試題.json")
    if os.path.exists(path_114_scene):
        ...
        if fix_question(data, 7, "D", "1234"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/114年/刑案現場 Q7: 補齊選項D='1234'")
        ...
        if fix_question(data, 11, "A", "12345"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/114年/刑案現場 Q11: 補齊選項A='12345'")

        save_json(path_114_scene, data)

    # ================================================================
    # 10. 鑑識科學學系 108年 犯罪偵查 Q3（缺A）
    # ================================================================
    path_108_forensic = os.path.join(QUIZ_DIR, "鑑識科學學系", "108年", "犯罪偵查", "試題.json")
    if os.path.exists(path_108_forensic):
        ...
        if fix_question(data, 3, "A", "1345"):
            fixes_applied += 1
            print("[OK] 鑑識科學學系/108年/犯罪偵查 Q3: 補齊選項A='1345'")

        save_json(path_108_forensic, data)

    # ================================================================
    # 11. 刑事警察學系 106年 刑案現場處理與刑事鑑識 Q17（B=原始資料缺失）
    # ================================================================
    path_106_scene = os.path.join(QUIZ_DIR, "刑事警察學系", "106年", "刑案現場處理與刑事鑑識", "試題.json")
    if os.path.exists(path_106_scene):
        ...
        if fix_question(data, 17, "B", "1356"):
            fixes_applied += 1
            print("[OK] 刑事警察學系/106年/刑案現場 Q17: 修復選項B='1356'")

        save_json(path_106_scene, data)

    # ================================================================
    # 12. 水上警察學系 107年 水上警察學系情境實務 Q7 — empty_option 和垃圾文字
    # ================================================================
    water_pattern = os.path.join(QUIZ_DIR, "水上警察學系", "107年", "水上警察學系情境實務*", "試題.json")
    ...
    for fpath in water_files:
        ...
        for q in data["questions"]:
            if q.get("number") == 7 and q.get("type") == "choice":
                ...
                fixes_applied += 1
                print("[OK] 水上警察學系/107年/水上警察學系情境實務 Q7: 修復四個選項（拆分並清除垃圾文字）")
                break
        save_json(fpath, data)
