...
考選部部分 PDF 以 Private Use Area 字元表示題內編號與選項標記。本工具
只處理已由歷年資料與原卷畫面確認的碼位；遇到未知 PUA 時立即失敗，避免
把可能具有語意的符號直接刪除。
"""
...
PUA_MAP = {
    # 題內阿拉伯編號：原卷顯示 1. 至 10.；U+E0C6、U+E0C7 已由
    # 115 年「諮商輔導與婦幼保護」原卷第 1 題畫面逐字核對。
    "\ue0c6": "1.",
    "\ue0c7": "2.",
    "\ue0c8": "3.",
    "\ue0c9": "4.",
    ...
    "\ue133": "⑪",
    "\ue134": "⑫",
    # 中文分項序號；來自專案歷年 PUA 對照表。
    "\ue1c0": "㈠",
    "\ue1c1": "㈡",
    "\ue1c2": "㈢",
    "\ue1c3": "㈣",
    # 選項標記；與既有解析器的 PUA_MAP 一致。
    "\ue18c": "(A)",
    "\ue18d": "(B)",
    "\ue18e": "(C)",
    "\ue18f": "(D)",
